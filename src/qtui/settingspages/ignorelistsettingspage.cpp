    ...
    , _hasChanged(enabled)
{
    ...
    connect(&_typeButtonGroup, &QButtonGroup::buttonClicked, this, &IgnoreListEditDlg::widgetHasChanged);
    connect(&_strictnessButtonGroup, &QButtonGroup::buttonClicked, this, &IgnoreListEditDlg::widgetHasChanged);
    connect(&_scopeButtonGroup, &QButtonGroup::buttonClicked, this, &IgnoreListEditDlg::widgetHasChanged);
